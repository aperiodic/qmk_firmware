...
static void select_row(uint8_t row) {
    if (row < 7) {
        ...
        if (!mcp23018_status) {
            ...
            mcp23018_status = i2c_start(I2C_ADDR_WRITE, ERGODOX_FN_I2C_TIMEOUT);        if (mcp23018_status) goto out;
            mcp23018_status = i2c_write(GPIOA, ERGODOX_FN_I2C_TIMEOUT);                 if (mcp23018_status) goto out;
            mcp23018_status = i2c_write(0xFF & ~(1 << row), ERGODOX_FN_I2C_TIMEOUT);    if (mcp23018_status) goto out;
        out:
            i2c_stop();
        }
    } else {
